...
RDPS_BEGIN typedef FRWK SphericalLamp			SphericalLamp;			 RDPS_END
RDPS_BEGIN typedef FRWK Sphere					Sphere;					 RDPS_END
RDPS_BEGIN typedef FRWK AmbientLight			AmbientLight;			 RDPS_END
RDPS_BEGIN typedef FRWK AmbientOccluder			AmbientOccluder;		 RDPS_END
...
RDPS_BEGIN typedef FRWK BRDF					BRDF;					 RDPS_END
RDPS_BEGIN typedef FRWK GlossySpecular			GlossySpecular;			 RDPS_END
...
RDPS_BEGIN typedef FRWK ReflectiveMaterial		ReflectiveMaterial;		 RDPS_END
